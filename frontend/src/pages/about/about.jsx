...
function About() {
  return (
    <div className="flex flex-col md:flex-row m-2 p-4 md:p-20 rounded-lg shadow-lg"> 
      <div className="relative bg-gray-800/50 backdrop-blur-sm m-0 md:m-20 p-4 md:p-8 rounded-lg shadow-lg w-full md:w-auto" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="10"> {/* Added w-full for mobile, w-auto for larger screens */}
