...
const Contact = () => {
  ...
  return (
        <div className="min-h-screen w-full bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 text-white">
          <div className="max-w-7xl mx-auto flex flex-col gap-12">
            <div className="flex flex-col lg:flex-row gap-8">
              <div className="w-full lg:w-1/3 flex flex-col gap-6">
                <div className="bg-gray-800 p-6 rounded-xl shadow-lg flex items-start gap-4 hover:shadow-xl transition-shadow">
                  <FaMapMarkerAlt className="text-blue-500 text-3xl mt-1 flex-shrink-0" />
                  <div>
                ...
                <div className="bg-gray-800 p-6 rounded-xl shadow-lg flex items-start gap-4 hover:shadow-xl transition-shadow">
                  <FaPhone className="text-blue-500 text-3xl mt-1 flex-shrink-0" />
                  <div>
                ...
                <div className="bg-gray-800 p-6 rounded-xl shadow-lg flex items-start gap-4 hover:shadow-xl transition-shadow">
                  <FaEnvelope className="text-blue-500 text-3xl mt-1 flex-shrink-0" />
                  <div>
              ...
              <div className="w-full lg:w-2/3 bg-gray-800 rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
            ...
            <div className="bg-gray-800 rounded-xl shadow-lg p-8 mx-auto w-full max-w-2xl hover:shadow-xl transition-shadow">
